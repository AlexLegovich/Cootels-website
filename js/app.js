(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".burger-header")) document.addEventListener("click", (function(e) {
        ...
        const roomLinks = document.querySelectorAll(".item-room__link");
        roomLinks.forEach((link => {
            link.addEventListener("mouseenter", (() => {
                const image = link.closest(".item-room").querySelector(".item-room__image img");
                if (image) image.classList.add("scaled");
            }));
            link.addEventListener("mouseleave", (() => {
                const image = link.closest(".item-room").querySelector(".item-room__image img");
                if (image) image.classList.remove("scaled");
            }));
        }));
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            accordions.forEach((el => {
                el.addEventListener("click", (e => {
                    ...
                    self.querySelector(".accordions__control");
                    const content = self.querySelector(".accordions__content");
                    accordions.forEach((otherAccordion => {
                        if (otherAccordion !== self && otherAccordion.classList.contains("open")) {
                            otherAccordion.classList.remove("open");
                            const otherContent = otherAccordion.querySelector(".accordions__content");
                            otherContent.style.maxHeight = null;
                        }
                    }));
                    self.classList.toggle("open");
                    if (self.classList.contains("open")) content.style.maxHeight = content.scrollHeight + "px"; else content.style.maxHeight = null;
                }));
            }));
        }));
        window["FLS"] = true;
